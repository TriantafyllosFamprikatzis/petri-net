def water_gui(canvas, tk):
    ...
    textpfinal = canvas.create_text(985, 90, text='P7')
    ...
    T10_TK = canvas.create_rectangle(505, 130, 535, 150, outline='black', width=2)
    ...
    line = canvas.create_line(540, 40, 965, 85, arrow=tk.LAST)#t9-f
    line = canvas.create_line(460, 140, 500, 140, arrow=tk.LAST)#p6-t11
    line = canvas.create_line(540, 140, 965, 95, arrow=tk.LAST)#t11-f
